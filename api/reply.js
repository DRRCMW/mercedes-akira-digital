...
export default async function handler(req, res) {
  ...
  const msg = `Thanks${first ? ' ' + esc(first) : ''}! This is Robyn with Akira Digital. Grab any 15-min slot that works for you and let's talk: cal.com/akira-digital â or just reply with a good time to call.`;
